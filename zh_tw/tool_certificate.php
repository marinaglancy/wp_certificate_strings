...
/**
 * Strings for component 'tool_certificate', language 'zh_tw_wp', version '3.11'.
 *
...
$string['certificatesissued'] = '已頒發證書';
...
$string['entitycertificateissues'] = '頒佈證書';
...
$string['issuenewcertificates'] = '頒發新證書';
...
$string['outcomecertificate'] = '頒發證書';
$string['outcomecertificatedescription'] = '頒發證書 \'{$a}\' 給用戶';
$string['page'] = '第 {$a} 頁';
...
$string['toomanycertificatestoshow'] = '太多證書 ({$a}) 以至於無法顯示';
$string['type'] = '類型';
